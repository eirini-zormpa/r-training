...
- :recycle: it supports reproducibility through features like `projects`.
...
interviews <- read_csv("/Users/Eirini.zormpa/Documents/rsa-r-training/data_raw/synthetic-census-data.csv")

# option 2: relative path
ceramics_data <- read_csv("data_raw/synthetic-census-data.csv")
```
